...
import { completeAdminOnboarding, completeStaffOnboarding } from '../../../../services/flowers/team';
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      ...
      if (isAdmin) {
        ...
        await completeAdminOnboarding(user.id, password);
      ...
      <div className="flower-card w-full max-w-md p-6 sm:p-8">
        ...
        <p className="mt-2 text-sm text-brand-brown/80">
          ...
          {isAdmin
            ...
            ? 'Set a personal password before you start. Your temporary password '
